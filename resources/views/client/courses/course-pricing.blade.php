                    ...
                    <div class="plan-box">
                        <div style="display: flex; align-items: center;">
                            <div style="margin-right: 20px;">
                                ...
                                <p style="font-size: 20px; font-weight: bold; color: #333; text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);">
                ...
                <div class="col-lg-4">
                    <div class="benefit-box">
                        ...
                        <form action="{{ route('promotion') }}" method="POST" class="promotion-form">
                            ...
                            <input type="text" name="discount_code" placeholder="Nhập mã khuyến mãi" class="form-control">
                        ...
                        <form action="{{ route('client.checkout') }}" method="post">
                            ...
                            <hr>
                            <a href="javascript:void(0);" class="btn btn-secondary w-100" id="cancel-payment-btn">Hủy thanh toán</a>
                        </form>
                    </div>
