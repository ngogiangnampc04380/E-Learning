<!-- resources/views/client/courses/show-quiz.blade.php -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 mt-3">
                    <h1 class="mb-4">Chi Tiết Bài Quiz</h1>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="card-title">Tiêu đề: {{ $quiz->name }}</h5>
                            <p class="card-text"><strong>Khóa học:</strong> {{ $quiz->course->name }}</p>
                            <p class="card-text"><strong>Chương:</strong> {{ $quiz->chapter->name }}</p>
                        </div>
                    </div>
