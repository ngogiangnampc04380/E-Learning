                            ...
                            <div class="settings-widget">
                                @if ($data->contains('status', 0))
                                    <div class="settings-inner-blk p-4 bg-light rounded shadow">
                                        <div class="sell-course-head comman-space text-center mb-4">
                                            ...
                                            <p class="text-muted lead">Quản lý và cập nhật các khóa học của bạn, bao gồm
                                                trạng thái và thông tin chi tiết.</p>
                                        </div>

                                        <div
                                            class="settings-tickets-blk course-instruct-blk table-responsive rounded shadow-sm p-3 bg-white">
                                                    ...
                                                    @foreach ($data as $post)
                                                        @if ($post->status == 0)
                                                            <tr>
                                                                <td>
                                                                    <a href="#">
                                                                        <img src="{{ Storage::url('public/' . $post->thumbnail) }}"
                                                                            alt="Thumbnail"
                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <!-- Nút Xóa -->
                                                                        <form
                                                                            action="{{ route('client.deleteCourse', $post->id) }}"
                                                                            method="POST" class="delete-course-form">
                                                                            @csrf
                                                                            <button type="button"
                                                                        ...
                                                                        <!-- Nút Sửa -->
                                                                        <a href="{{ route('client.editCourse', $post->id) }}"
                                                                            class="btn btn-outline-common mx-2">
                                                                        ...
                                                                        <!-- Nút Gửi duyệt -->
                                                                        <form
                                                                            action="{{ route('client.submitCourse', $post->id) }}"
                                                                            method="POST" class="submit-course-form">
                                                                            @csrf
                                                                            @method('POST')
                                                                            <button type="button"
                                                                                class="btn btn-success submit-course-btn ">
                                ...
                                @if (!$data->contains('status', 0) && !$data->contains('status', 1) && !$data->contains('status', 2))
                                    <div class="settings-inner-blk p-4 bg-light rounded shadow text-center my-5">
                                        ...
                                        <p class="text-muted lead mb-4">Bạn có thể bắt đầu tạo khóa học ngay bây giờ và
                                            chia sẻ kiến thức của mình với mọi người.</p>
                                        <a href="{{ route('client.create-course') }}"
                                ...
                                @if ($data->contains('status', 1))
                                    <div class="settings-inner-blk p-4 bg-light rounded shadow">
                                        <div class="sell-course-head comman-space text-center mb-4">
                                            ...
                                            <p class="text-muted lead">Các khóa học đã được gửi đến người quản trị trang
                                                web để chờ được xét duyệt</p>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <table class="table table-striped table-hover">
                                                <thead class="table-primary">
                                                    <tr>
                                                        <th
                                                            style="background: #00ff00; background: linear-gradient(#00ff00, #289a16);">
                                                            Hình ảnh</th>
                                                        <th
                                                            style="background: #00ff00; background: linear-gradient(#00ff00, #289a16);">
                                                            Video demo</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <!-- Nút Thu hồi -->
                                                                        <form
                                                                            action="{{ route('client.recallCourse', $post->id) }}"
                                                                            method="POST" class="recall-course-form">
                                                                            @csrf
                                                                            @method('POST')
                                                                            <button type="button"
                                                                                class="btn btn-danger recall-course-btn">
                                ...
                                @if ($data->contains('status', 2))
                                    <div class="settings-inner-blk p-4 bg-light rounded shadow">
                                        <div class="sell-course-head comman-space text-center mb-4">
                                            ...
                                            <p class="text-muted lead">Các khóa học đã được duyệt và sẽ công khai trên
                                                website</p>
                                        </div>
                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <form
                                                                            ...
                                                                            @csrf
                                                                            <button type="button"
                                                                                class="btn btn-outline-danger delete-course-btn rounded-pill">
                                                                                <i class="fas fa-trash-alt"></i> Xóa
                                                                            </button>
                                                                        </form>
