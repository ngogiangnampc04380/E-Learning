...
@section('content')
            ...
            <div class="w-100">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex justify-between gap-10">
                                ...
                                <div class="self-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 58 36"
                                        height="36" width="58">
                                        <circle fill-opacity="0.62" fill="#F9CCD1" r="18" cy="18" cx="18">
                                        </circle>
                    ...
                    <div id="where_card_infor" style="display: none"
                        class="card relative h-[280px] w-[450px] flex flex-col justify-end px-6 py-10 rounded-3xl gap-8 bg-gradient-to-r from-orange-3000 to-orange-4000">
                        Vị Trí :
    ...
    <script>
        ...
        const FPT_API_KEY = 'Gifw2OFyLISjYnPc0MKfcixahku1j5Tx'
                                ...
                                switch (errr_code) {
                                    case 0: {
                                        if (!data['data'][0]['issue_loc']) {
                                            ...
                                            document.querySelector('#where_card_infor').innerHTML += '<b>' + data[
                                                'data'][0]['issue_loc'] + '</b>'
                                            loader.style.display = 'none'
                                            const successStyle = {
                                                background: '#159f46',
